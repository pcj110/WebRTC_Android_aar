 ...
 */
public class GWebRTC_AsyncHttpURLConnection {
    private static final int HTTP_TIMEOUT_MS = 8000;
    private static final String HTTP_ORIGIN = GWebRTC_AppRTC_Common.HTTP_ORIGIN;
    ...
    private String TAG = GWebRTC_AppRTC_Common.TAG_COMM + "AsyncHttp";
     ...
     * @param events
     */
    public GWebRTC_AsyncHttpURLConnection(String method, String url, String message, AsyncHttpEvents events) {
        this.method = method;
        this.url = url;
