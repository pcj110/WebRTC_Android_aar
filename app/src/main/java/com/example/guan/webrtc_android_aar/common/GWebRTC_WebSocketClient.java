...
public class GWebRTC_WebSocketClient {
    private static final String TAG = GWebRTC_AppRTC_Common.TAG_COMM + "WSClient";
     ...
     * @param handler
     */
    public GWebRTC_WebSocketClient(Handler handler, IWebSocketMessageEvent events, String roomID) {
    ...
    private void sendWSSMessage(final String method, final String message) {
        ...
        GWebRTC_AsyncHttpURLConnection httpConnection =
                new GWebRTC_AsyncHttpURLConnection(method, postUrl, message, new GWebRTC_AsyncHttpURLConnection.AsyncHttpEvents() {
                    @Override
