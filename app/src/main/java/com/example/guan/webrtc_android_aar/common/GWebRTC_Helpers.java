...
public class GWebRTC_Helpers {
    public static String TAG = GWebRTC_AppRTC_Common.TAG_COMM + "Helpers";
    ...
    public static LinkedList<PeerConnection.IceServer> requestTurnServers(String url)
        ...
        //这句话仅仅为了测试
        url = GWebRTC_AppRTC_Common.selected_turnServer_URL;

        LinkedList<PeerConnection.IceServer> turnServers = new LinkedList<PeerConnection.IceServer>();
        Log.d(TAG, "Request TURN from: " + url);
        HttpURLConnection connection = (HttpURLConnection) new URL(url).openConnection();
        connection.setDoOutput(true);
        connection.setRequestProperty("REFERER", GWebRTC_AppRTC_Common.selected_WebRTC_URL);
