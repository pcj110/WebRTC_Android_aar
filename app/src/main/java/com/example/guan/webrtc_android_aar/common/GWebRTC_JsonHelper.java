...
import static com.example.guan.webrtc_android_aar.common.GWebRTC_Helpers.requestTurnServers;

/**
 * Created by guan on 10/20/16.
 */

public class GWebRTC_JsonHelper {

    public static String TAG = GWebRTC_AppRTC_Common.TAG_COMM + "JsonHelper";
     ...
     * @param response
     */
    public static GWebRTC_AppRTC_Common.SignalingParameters roomHttpResponseParse(String response) {
        ...
        try {
            ...
            if (result.equals("FULL")) {
                Log.e(TAG, "ROOM_FULL");
                GWebRTC_AppRTC_Common.SignalingParameters params = new GWebRTC_AppRTC_Common.SignalingParameters(result,
    ...
    public static GWebRTC_AppRTC_Common.MessageParameters messageHttpResponseParameters(String response) {
        ...
        try {
            ...
            return new GWebRTC_AppRTC_Common.MessageParameters(roomId, clientId,
