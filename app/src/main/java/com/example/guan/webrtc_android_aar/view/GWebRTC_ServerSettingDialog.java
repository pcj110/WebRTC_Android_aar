...
public class GWebRTC_ServerSettingDialog extends Dialog {
    ...
    public GWebRTC_ServerSettingDialog(Context context) {
    ...
    private void setCustomeDialog() {
        View mView = LayoutInflater.from(getContext()).inflate(R.layout.dialog_serversetting_gwebrtc, null);
...
//                        break;
//                }
                GWebRTC_ServerSettingDialog.this.dismiss();
            }
        });
