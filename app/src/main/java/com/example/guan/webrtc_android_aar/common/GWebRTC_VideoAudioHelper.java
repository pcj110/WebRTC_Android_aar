...
public class GWebRTC_VideoAudioHelper {

    String TAG = GWebRTC_AppRTC_Common.TAG_COMM + "VideoAudioHelper";
    Context context;
    ...
    public GWebRTC_VideoAudioHelper(Context context, PeerConnectionFactory factory, SurfaceViewRenderer localRender) {
